...
class FrontIndex(DBackHandler):
    ...
    def get(self):
        ...
        page_holder = article_service.get_bean_page(page_size, page_no,
                                                    query_filter, None)
        ...
        return self.render('for_front/v1/front_index_v1.html',
...
class Detail(DBackHandler):
    ...
    def get(self):
        ...
        return self.render('for_front/v1/front_article_detail_v1.html',

...
class BaseCRUDService(object):
    ...
    def get_bean_page(self, page_size, page_no, where=None, order=None):
        ...
        page = pw_utils.get_entity_page(entity_class, page_no, page_size,
                                        where, order)
        dto_list = []
    ...
    def get_bean_by_id(self, aid):
        ...
        db_modal = self.entity_class.select(
            self.entity_class).where(self.entity_class.id == aid).first()
...
class BaseCRUDOrderService(BaseCRUDService):
    ...
    def save_entity_by_map(self, uid, map_data):
        ...
        max_value = pw_utils.get_max_of_field(self.entity_class,
                                              self.order_field)
    ...
    def do_move_up(self, aid):
        ...
        min_order = pw_utils.get_min_of_field(self.entity_class,
                                              self.order_field)
        ...
        to_obj = pw_utils.get_entity_by_field(self.entity_class,
                                              self.order_field, to_order_value)
        to_order_value += 1
    ...
    def do_move_down(self, aid):
        ...
        max_order = pw_utils.get_max_of_field(self.entity_class,
                                              self.order_field)

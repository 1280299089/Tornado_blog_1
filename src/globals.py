#! /usr/bin/python
# -*- coding: UTF-8 -*-
# import ConfigParser  # 这是python2.x时候的模块，3.x后全是小写
import configparser
import logging
import os
import os.path
...
g_config_parser.readfp(
    open(os.path.join(g_project_root, 'conf/dblog.conf'), encoding='utf-8'))
...
def start_tornado():
    ...
    settings = {
        ...
        "debug": debug,
        "cookie_secret":
        '62oETzKXQAGaYdkL5gEmGeKJFuYh7EQnp2XdTP1o/Vo=',  # With the signature of cookie
